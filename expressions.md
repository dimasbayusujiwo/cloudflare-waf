# Cloudflare WAF Expression Sets

## Expression Set 1: Rules Keamanan Utama
**Action:** Block
...
(http.user_agent eq "" and not http.host contains "api." and not http.host contains "cdn.") or
(http.user_agent wildcard "*embeddedbrowser*" and not http.host contains "api." and not http.host contains "cdn.") or
(http.user_agent wildcard "*go-http-client*" and not http.host contains "api." and not http.host contains "cdn.") or
...
## Expression Set 2: Rules Keamanan Sekunder
**Action:** Block
...
(http.request.uri.path wildcard "*.log*" and not http.request.uri.path contains "ReShade.log" and not http.host contains "cdn.") or
...
## Expression Set 3: Klien Kedaluwarsa
...
## Expression Set 4: Filter Klien otomatisasi
**Action:** Block
...
## Expression Set 5: Network-Level Restrictions
**Action:** Block
...
(ip.src in {
    ...
    222.73.130.30         176.31.174.113        107.174.244.108
})
```
